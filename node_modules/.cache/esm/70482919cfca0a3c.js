 ...
 */
module.exports=function(sourceCode){return eval(_cfc‍.c('try {if (wallaby._frameworks.sinon) {var sinon = require("sinon");wallaby._frameworks.sinon.wrapped.forEach(function(obj) { sinon.restore(obj); });wallaby._frameworks.sinon.stubs.forEach(function(obj) { obj.restore(); });wallaby._frameworks.sinon.wrapped = [];}} catch(e) { }try {if (global.jasmine && global.jasmine._wallabyUndoSpies) {global.jasmine._wallabyUndoSpies();}} catch(e) { }'+(sourceCode?"try {  var moduleFileName = module.filename; delete module.filename; ("+sourceCode+")(wallaby); }finally { module.filename = moduleFileName; }":"")))};